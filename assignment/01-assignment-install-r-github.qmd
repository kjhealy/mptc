...
This is the first assignment for the course. It has two parts. The first part is to install R and RStudio, and the second part is to set up your GitHub account and connect it to RStudio. You should complete this assignment before the first class meeting. I _strongly_ encourage you to talk to your fellow classmates about the assignment and to help each other out.
