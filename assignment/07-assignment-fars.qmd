...
1. Launch the project by double-clicking on the `07-problem-set.Rproj` file. It will launch a new instance of R. Remember you can have more than one project open and running at a time. Each one is a self-contained RStudio instance. They don't know anything about each other.
