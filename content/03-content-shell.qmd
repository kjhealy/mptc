---
title: "03. The File System and the Shell"
date: last-modified
date-format: full
---
...
_After_ you have completed this week's [assignment](/assignment/03-assignment-shell.qmd), read the first chapter of @barrett22:_effic_linux.
...
[This week's examples and demos](/example/03-example-shell.qmd).


## Assignment, parts 1 and 2

[This week's assignment, part 1](/assignment/03-assignment-shell.qmd).

[This week's assignment, part 2](/assignment/03-assignment-shell-2.qmd).
...
<iframe class="slide-deck" id="quartoframe" src="../slides/03-slides-filesystem.html"></iframe>
```

```{r show-slide-tabs, echo=FALSE, results="asis"}
slide_win_button("/slides/03-slides-filesystem")
```


```{=html}
<iframe class="slide-deck" id="quartoframe" src="../slides/03-slides-shell.html"></iframe>
```

```{r show-slide-tabs2, echo=FALSE, results="asis"}
slide_win_button("/slides/03-slides-shell")
```
