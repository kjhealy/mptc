...
- This week (and only this week) there are _two_ assignments. [Assignment 00](/assignment/00-assignment-install-r-github.qmd) is due on the first day of class. [Assignment 01]()(/assignment/01-assignment-quarto-notes.qmd) is due the Friday after the first day.

## Slides

(Will appear here after the seminar.)
