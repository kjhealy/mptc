...
This section contains worked examples related to what we've been covering. You will see both chunks of code and the output the code produces as well. For example here are some shell commands:
