...
- [**Assignment**](/assignment/) ({{< fa pen-ruler >}}): These pages contain the instructions for each problem set. Except in the first week, assignments from a Monday class are due by 6pm the following _Friday_.
