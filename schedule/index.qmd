...
Here's a tentative outline. It's subject to change. There are up to three kinds of link each week. 
...
- [**Assignment**](/assignment/) ({{< fa pen-ruler >}}): These pages contain the instructions for each problem set. The problem set assiged in any given week is due the following _Sunday_ by *6:00pm*. 
