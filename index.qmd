...
2. **The Idea of a Shell**  
    The terminal and the command line environment
...
5. **The Idea of a Build System**  
    Make, targets, and Quarto

6. **The Idea of the Network**  
    Servers, websites, and APIs

Or to put the topics a little differently, we will try to learn the elements of (1) How to name things, (2) How to find things, (3) How to slice and dice things, (4) How to keep track of things, (5) How to assemble things, and (6) How to talk to things. The reason I list them with a header and a tag line is that throughout the seminar we will move back and forth between two perspectives. First, and most concretely, we will learn about *specific tools* and various tricks associated with using them. That's the stuff mentioned in the tag lines. At this level we will focus on examples that come up in our everyday work. But second, and more generally, we will try to develop a *way of thinking* about them. That's the idea in the header. We don't need to learn every tool in the box right away. There are far too many of them to even try, in any case. Rather, we will try to develop the ability---and fortitude---to learn how to learn more. That way, we can foster strategies to solve problems as they (inevitably) arise, even when those problems are (undeniably) frustrating. As we shall hopefully see, each of the particular thing we learn about is really an example of one way to solve a specific sort of recurring problem in our work. The 
