...
We have thirteen class weeks for this seminar, excluding Fall Break. During that time we will learn some elements of plain-text computing that every graduate student in the social sciences (and beyond!) should know something about. They are:
...
show_table <- function(group_id) {
  ...
  tbl <- schedule_nested$data[[group_id]] %>%
    ...
    column_spec(3, width = "65%", extra_css = "font-style: normal;")
  cat(tbl)
}
```
