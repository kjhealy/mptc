...
- The file system and the Unix way of thinking _or_  **The Idea of Your Computer**  
- The command line environment and the terminal _or_ **The Idea of a Shell**
- Editors and regular expressions _or_ **The Idea of Plain Text** 
- Git and GitHub _or_ **The Idea of Version Control**
- Make and {{targets}} _or_  **The Idea of a Build System**
- Servers and APIs _or_ **The Idea of a Network**

The reason I list them in this way is that throughout the seminar we will move back and forth between two perspectives. First, and most concretely, we will learn about *specific tools* and various tricks associated with using them. At this level we will focus on examples that come up in our everyday work. But second, and more generally, we will try to develop a *way of thinking* about them. We don't need to learn every tool in the box right away. There are far too many of them to even try, in any case. Rather, we will try to develop the ability---and fortitude---to learn how to learn more. That way, we can foster strategies to solve problems as they (inevitably) arise, even when those problems are (undeniably) frustrating. As we shall hopefully see, each of the particular thing we learn about is really an example of one way to solve a specific sort of recurring problem in our work. 
