...
subtitle: "Modern Plain Text Social Science: Week 9"
...
ifelse(!dir.exists(here("figures")), dir.create(here("figures")), message("`figures` already exists"))
...
## Peek again in the [`figures/`]{.fg-orange} folder
