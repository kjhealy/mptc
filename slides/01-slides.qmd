...
```{.bash}
❯ pwd
/Users/kjhealy/Documents/courses
```
...
```{.bash}
❯ ls
assets             data_visualization mptc               soc101             soc880             vsd_notes
contemp-theory     data_wrangling     old                soc110             theory             vsd_proj_template
data_management    grad-theory        other_people       soc355             vsd                workshops
```
...
❯ cd mptc
❯ ls                                                                                              
R              _extensions    _targets.R     assignment     example        mptc.Rproj     slides
README.md      _quarto.yml    _variables.yml content        files          renv
README.qmd     _site          about          data           html           renv.lock
README_files   _targets       assets         deploy.sh      index.qmd      schedule
```
...
-rw-r--r--@  1 kjhealy  staff   1206 Aug 15 20:24 README.qmd
drwxr-xr-x@  3 kjhealy  staff     96 Aug 15 20:29 README_files
drwxr-xr-x@  4 kjhealy  staff    128 Aug 11 21:11 _extensions
-rw-r--r--@  1 kjhealy  staff   2239 Aug 16 16:06 _quarto.yml
drwxr-xr-x@ 15 kjhealy  staff    480 Aug 29 10:12 _site
drwxr-xr-x@  6 kjhealy  staff    192 Aug 29 10:12 _targets
-rw-r--r--@  1 kjhealy  staff   3548 Aug 16 13:37 _targets.R
-rw-r--r--@  1 kjhealy  staff    799 Aug 16 13:53 _variables.yml
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 10:12 about
drwxr-xr-x@  6 kjhealy  staff    192 Aug 14 06:58 assets
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 10:12 assignment
drwxr-xr-x@  4 kjhealy  staff    128 Aug 29 10:12 content
drwxr-xr-x@  3 kjhealy  staff     96 Aug 17 08:41 data
-rwxr-xr-x@  1 kjhealy  staff    369 Aug 15 19:55 deploy.sh
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 10:12 example
drwxr-xr-x@  5 kjhealy  staff    160 Aug 28 15:16 files
drwxr-xr-x@ 13 kjhealy  staff    416 Aug 10 17:00 html
-rw-r--r--@  1 kjhealy  staff   6244 Aug 16 12:34 index.qmd
-rw-r--r--@  1 kjhealy  staff    258 Aug 21 20:26 mptc.Rproj
drwxr-xr-x@  7 kjhealy  staff    224 Aug 15 17:04 renv
-rw-r--r--@  1 kjhealy  staff  48102 Aug 21 08:15 renv.lock
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 10:12 schedule
drwxr-xr-x@  4 kjhealy  staff    128 Aug 29 10:12 slides
```
...
drwxr-xr-x@  4 kjhealy  staff    128 Aug 11 21:11 _extensions
-rw-r--r--@  1 kjhealy  staff   2239 Aug 16 16:06 _quarto.yml
drwxr-xr-x@ 15 kjhealy  staff    480 Aug 29 11:50 _site
drwxr-xr-x@  6 kjhealy  staff    192 Aug 29 11:50 _targets
-rw-r--r--@  1 kjhealy  staff   3548 Aug 16 13:37 _targets.R
-rw-r--r--@  1 kjhealy  staff    799 Aug 16 13:53 _variables.yml
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 11:50 about
drwxr-xr-x@  6 kjhealy  staff    192 Aug 14 06:58 assets
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 11:50 assignment
drwxr-xr-x@  4 kjhealy  staff    128 Aug 29 11:50 content
drwxr-xr-x@  3 kjhealy  staff     96 Aug 17 08:41 data
-rwxr-xr-x@  1 kjhealy  staff    369 Aug 15 19:55 deploy.sh
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 11:50 example
drwxr-xr-x@  5 kjhealy  staff    160 Aug 28 15:16 files
drwxr-xr-x@ 13 kjhealy  staff    416 Aug 10 17:00 html
-rw-r--r--@  1 kjhealy  staff   6244 Aug 16 12:34 index.qmd
-rw-r--r--@  1 kjhealy  staff    258 Aug 21 20:26 mptc.Rproj
drwxr-xr-x@  7 kjhealy  staff    224 Aug 15 17:04 renv
-rw-r--r--@  1 kjhealy  staff  48102 Aug 21 08:15 renv.lock
drwxr-xr-x@  3 kjhealy  staff     96 Aug 29 11:50 schedule
drwxr-xr-x@  4 kjhealy  staff    128 Aug 29 11:50 slides
```
...
```{.bash}
❯ awk '// {print $11}' access.log | sort | uniq -c | sort -nr | head -n 20
   ...
   1373 "https://socviz.co/groupfacettx.html"
    ...
    153 "https://www.google.com/"
     50 "http://vissoc.co/"
     39 "https://socviz.co/lookatdata.html?zarsrc=30&utm_source=zalo&utm_medium=zalo"
     31 "http://vissoc.co"
     31 "http://socviz.co/"
     27 "https://www.bookdown.org/"
     23 "https://bookdown.org/home/"
