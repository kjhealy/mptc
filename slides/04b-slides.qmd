...
:::: {.columns}
::: {.column width="50%"}
- Top 5 by n candidates standing
```{r}
...
- Median vote share of winners?
- Largest vote share swing from previous election?
- Turnout?
- Other things?

## Harder

- Counts by region in the UK? (i.e. Wales, England, Scotland, Northern Ireland)
