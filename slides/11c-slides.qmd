...
![Many palettes](../assets/11-graph/08_colorspace_package.png)
...
![The relationship of interest](../assets/11-graph/08_status_conceptual.png)

## Build from ideas to data

![Theory says ...](../assets/11-graph/08_status_hypotheses.png)


## Build from ideas to data

![Data suggests ...](../assets/11-graph/08_status_results.png)

---

## Repeat to [differentiate]{.fg-lblue}

![Pointrange](../assets/11-graph/08_model_controls_pointrange_IRRs_MASSnb.png)


## Repeat to [differentiate]{.fg-lblue}

![Add a comparison group](../assets/11-graph/08_mode_lsm_nb_gender_journal.png)

## Layer and repeat with [facets]{.fg-lblue}

![Compare across facets](../assets/11-graph/08_growth_curve_quantile_quantreg_gender.png)

## Layer and repeat [across]{.fg-lblue} facets

![Layer to compare](../assets/11-graph/08_altservices.png)

---

## Layer and repeat [across]{.fg-lblue} facets

![Layer to copmare](../assets/11-graph/08_altservices2.png)


## X-Ray Vision

![Seeing through it](../assets/11-graph/08_layers_all_labeled.png)
