...
- It has a title, author, sections, a figure, tables, references, a footnote, and a bibliography.
- That is, it has many of the elements of a scholarly paper, in miniature.
...
## The source for both versions

![](../assets/01-file-system/01_mptc_oecd_github_page.png)

[https://github.com/kjhealy/mptc_oecd](https://github.com/kjhealy/mptc_oecd)

## Once you've downloaded it

![](../assets/01-file-system/01_mptc_oecd_finder.png)

It's a folder on your computer with a bunch of files in it.

## How did this go?

[Week 00 Assignment: Install R and RStudio](/assignment/00-assignment-install-r-github.qmd)

![](../assets/01-file-system/01_mptc_assignment_00.png)
...
- They are organized in some sort of [orderly fashion]{.fg-lblue} in a project folder. This folder lives somewhere.
- The [data]{.fg-lblue} originally came from somewhere else.
- We have some sort of [engine]{.fg-lblue} that assembled the pieces of the project into the PDF of the article.
- We have some kind of [application]{.fg-lblue} that helps us run the engine and manage the project.
...
- Most interaction via windows, icons, a pointer, and the keyboard.
...
- Underneath, it's often the 1970s, Unix, and the command-line. You get to see and often need to interact with this directly.
...
- It's also very good for computing in the sense that _all_ scholarly work is technical, i.e. it must meet specific procedural demands.
...
- Final output is often in the same format you've been working in, e.g. a Word file, or that file converted to a PDF.
