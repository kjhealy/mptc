---
title: "R and Quarto"
subtitle: "Modern Plain Text Social Science<br />Week 04"
...
- This approach has its limitations, which we will return to, but it's _very_ useful and has many benefits.
...
![](../assets/04-r/02_function-masking.png){with=90%}
...
:::: {.columns}
::: {.column width="40%"}
![](../assets/04-r/02_summary-tree-atomic.png){width=90%}
...
:::: {.columns}
::: {.column width="40%"}
  ![](../assets/04-r/02_summary-tree-s3.png)
:::
...
![](../assets/04-r/02_error_object_length_warning.png){width=50%}

![](../assets/04-r/02_error_missing_comma.png){width=50%}

![](../assets/04-r/02_error_extra_paren.png){width=50%}
...
## Objects are like Bento Boxes {background-image="../assets/04-r/02_r_object_bento_box.png" background-size="cover"}

---

![The `p` object](../assets/04-r/02_r_objects_p_bleep.png)



---

![Peek in with the object inspector](../assets/04-r/02_r_object_inspector_panel.png)


---

![Peek in with the object inspector](../assets/04-r/04_r_ide_object_inspector.png)
