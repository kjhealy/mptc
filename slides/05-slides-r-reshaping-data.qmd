...
![](../assets/05-dplyr/05_feed-me-seymour.gif)
...
![](../assets/05-dplyr/05_tidy-gapminder.png)

## Tidy data

![](../assets/05-dplyr/05_tidy-1.png)
...
![](../assets/05-dplyr/05_census-untidy-small.png)
...
![](../assets/05-dplyr/05_election-spreadsheet.png)
...
![](../assets/05-dplyr/05_broman-and-woo.png){width=60%}

## Key points from Broman & Woo

![Use a consistent date format](../assets/05-dplyr/05_broman_woo_inconsistent_dates.png)
...
![](../assets/05-dplyr/05_broman_woo_implicit_repeats_and_headers.png)
...
![Tidied version](../assets/05-dplyr/05_broman_woo_tidied_1.png)

## Key points from Broman & Woo

![Rectangle your data](../assets/05-dplyr/05_broman_woo_non_rectangular.png)


## Key points from Broman & Woo

![Use more than one table if needed. We can join them later.](../assets/05-dplyr/05_broman_woo_5D_pair_tables.png)


## Key points from Broman & Woo

![Needs a single header row and a consistent naming scheme.](../assets/05-dplyr/05_broman_woo_multi_header_rows.png)


## Key points from Broman & Woo

![Tidied version.](../assets/05-dplyr/05_broman_woo_tidied_2.png)
