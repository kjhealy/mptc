...
- As soon as you try to do anything of any sort of technical complexity, depth, or just simple [reproducibility]{.fg-red} with your computer---even using the newest and coolest tools---[I promise you'll eventually find yourself in a world governed by the metaphors and methods Unix originated]{.fg-lblue}, and, very likely, in a literal Unix-derived environment. 
