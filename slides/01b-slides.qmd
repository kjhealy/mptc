...
## Why am I doing this? {.smaller}

In an era of Generative AI and Large Language Models and all the rest, why are we covering this stuff?

Two related answers: 

1. Unix is still everywhere and will be for a long time to come.

2. As soon as you try to do anything of any sort of complexity, depth, or even basic reliability with even the newest tools, [you'll almost certainly find yourself in a world governed by the metaphors and methods Unix originated]{.fg-red}. You will be in some sort of folder-based hierarchy consisting of plain-text files that are used to configure, launch, generate, or capture the output of executable applications by way of instructions written down as a series of commands following some regular syntax. 
