---
title: "The File System and the Shell"
...
- The general name for this mode of interacting with a computer is a _REPL_ or Read-Eval-Print Loop. 
- Programming languages like Python and R work this way as well. So does ChatGPT. They are _interpreted_, meaning code is sent to an interpreter (the Python or R program) that runs the code directly. 
...
# Everything underneath the `files/` subdirectory 
# whose name ends in `.png`
find files -name '*.png' -print0 | xargs -0 -r magick -format jpg
```
