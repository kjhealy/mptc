...
## Before we start {.incremental}

- Keep in mind the kinds of things we want to do. 
- In particular, we are constantly working with _rectangular tables of data_ consisting of _columns_ with information about _variables_
